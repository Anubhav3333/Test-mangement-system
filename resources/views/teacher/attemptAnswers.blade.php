...
<body>
    ...
    {{ $result == 'PASS' ? 'text-primary' : 'text-danger' }}">
                    {{ $result }}
                </span>
                <span class="score-label">Score</span>
                <span class="score-value"><h1>{{ $correctAnswers }}/{{ $totalAnswers }}</h1></span>
